...
![TODO: Update the path with the name of your diagram](Images/Azure Cloud Network Diagram.png)
...
- Load balances make sure the availability of the network is always accessable by acting as a reverse proxy and distributes network or application traffic across a number of servers. So none will be overloaded easy by an attack or high amounts of traffic.
...
![TODO: Update the path with the name of your screenshot of docker ps output](Images/Elk_Stack)
